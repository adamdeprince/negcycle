...
class LinuxAarch64AsimdArbitrageDetector final : public ArbitrageDetectorBase {
public:
  using Search = SimdSearch<LinuxAarch64AsimdArbitrageDetector, PortableSimd128Traits>;
...
NB_MODULE(_linux_aarch64_asimd, m) {
  negcycle::bind_detector_module<negcycle::LinuxAarch64AsimdArbitrageDetector>(
      m,
      "_LinuxAarch64AsimdArbitrageDetector",
      "Linux AArch64 ASIMD bounded simple-cycle arbitrage detector");
}
