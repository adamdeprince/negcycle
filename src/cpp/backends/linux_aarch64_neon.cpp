...
class LinuxAarch64NeonArbitrageDetector final : public ArbitrageDetectorBase {
public:
  using Search = SimdSearch<LinuxAarch64NeonArbitrageDetector, PortableSimd128Traits>;
...
NB_MODULE(_linux_aarch64_neon, m) {
  negcycle::bind_detector_module<negcycle::LinuxAarch64NeonArbitrageDetector>(
      m,
      "_LinuxAarch64NeonArbitrageDetector",
      "Linux AArch64 NEON bounded simple-cycle arbitrage detector");
}
