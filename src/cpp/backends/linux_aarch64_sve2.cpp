...
class LinuxAarch64Sve2ArbitrageDetector final : public ArbitrageDetectorBase {
public:
  using Search = SimdSearch<LinuxAarch64Sve2ArbitrageDetector, PortableSimd256Traits>;
...
NB_MODULE(_linux_aarch64_sve2, m) {
  negcycle::bind_detector_module<negcycle::LinuxAarch64Sve2ArbitrageDetector>(
      m,
      "_LinuxAarch64Sve2ArbitrageDetector",
      "Linux AArch64 SVE2 bounded simple-cycle arbitrage detector");
}
