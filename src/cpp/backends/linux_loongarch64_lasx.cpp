...
class LasxArbitrageDetector final : public ArbitrageDetectorBase {
public:
  using Search = SimdSearch<LasxArbitrageDetector, PortableSimd256Traits>;
...
NB_MODULE(_linux_loongarch64_lasx, m) {
  negcycle::bind_detector_module<negcycle::LasxArbitrageDetector>(
      m,
      "_LasxArbitrageDetector",
      "LoongArch LASX bounded simple-cycle arbitrage detector");
}
